...
app.post("/createOrder", accessTokenAuth_1.accessTokenAuth, (req, res) =>
...
app.get("/getOrders", accessTokenAuth_1.accessTokenAuth, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    (0, orderController_1.getOrders)(req, res);
  })
);
app.post("/createFood", multer_1.default.single("image"), (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    (0, foodController_1.createFood)(req, res);
  })
);
app.get("/getUserInfo", accessTokenAuth_1.accessTokenAuth, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    (0, userController_1.getUserInfo)(req, res);
  })
);
app.put("/updateUser", multer_1.default.single("image"), (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    (0, userController_1.updateUser)(req, res);
  })
);
app.post("/createInvoice", accessTokenAuth_1.accessTokenAuth, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.post("/checkPayment", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (
        ((_a = response.data.rows[0]) === null || _a === void 0
          ? void 0
          : _a.payment_status) === "PAID"
      ) {
        yield orderModel_1.default.findOneAndUpdate(
      ...
      return res
        .status(200)
        .send(
          (_b = response.data.rows[0]) === null || _b === void 0
            ? void 0
            : _b.payment_status
        );
    } catch (error) {
